...
/*Pawn can only move forward, unless it can take a piece, then it can move to the two forward diagonals 
...
public class Pawn extends Critter
{
  ...
  /*overriding the super get moveLocations() to see available moves for this piece
